...
# conda activate mm-r
model_tag=qwen25_retool_run_0826_chartqa_6k_bs128_reward_ocr_v2_new_w_sft_ckpt30
...
# /mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/reasoning_hc/data/Data_Mine/MM_ReTool/SFT_CoT_Data/0702/chartqa_60k_claude_required_codes.jsonl
DATA_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/reasoning_hc/data/Data_Mine/MM_ReTool/SFT_CoT_Data/0702/chartqa_60k_claude_required_codes.jsonl
...
export RAY_MASTER_PORT=6389
export RAY_DASHBOARD_PORT=8273
...
RAY_ADDRESS="http://127.0.0.1:$RAY_DASHBOARD_PORT" ray job submit \
  ...
  -- python3 -m openrlhf.cli.train_ppo_ray \
    --remote_rm_url examples/scripts/reward_func_qwen_instruct_retool_ocr_v2.py \
    --actor_num_nodes 1 \
